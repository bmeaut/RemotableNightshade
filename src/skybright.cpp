...
#ifdef LSS
	// Lionel patch for smaller Sun halo
	float FS = 18886.28f / (dist_sun + 0.0007f)+ pow10(6.15f - (dist_sun+0.001)* 1.43239f);
#else
	// Slightly larger halo to allow for good solar eclipses
	float FS = 18886.28f / (dist_sun*dist_sun*1.5 + 0.0007f)+ pow10(6.15f - (dist_sun+0.001)* 1.43239f);
#endif
