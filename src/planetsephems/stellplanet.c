...
void get_emb_helio_coordsv(const double jd,double xyz[3]) 
...
void get_emb_helio_osculating_coords(double jd0,double jd,double xyz[3])
  {GetVsop87OsculatingCoor(jd0,jd,VSOP87_EMB,xyz);}
// The following function was returning EMB rather than Earth
// Need to understand why since EMB != Earth
void get_earth_helio_osculating_coords(double jd0,double jd,double xyz[3])
//  {GetVsop87OsculatingCoor(jd0,jd,VSOP87_EMB,xyz);}
  {get_earth_helio_coordsv(jd, xyz);}
