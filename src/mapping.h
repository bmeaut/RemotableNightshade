...
public:
	...
	static Mapping* const Create( Mapping::MappingType );
...
private:
	// Keeps track of each type of map instantiated for cleanup on destruction
	static std::map<Mapping::MappingType, Mapping*> m_mapMap;
	Mapping::MappingType m_type;
};
