	...
	const char* cFragShaderSource = 
		"                                                               \n\
			...
			{															\n\
				...
				gl_FragColor = vec4(mix(color, cloudColor.rgb*cloudDiffuse*shadowScale, cloudColor.a), 1.0); \n\
			}															\n\
		";
}
...
void NightShader::setParams(GLhandleARB programObject, GLuint startActiveTex) const
{
}
