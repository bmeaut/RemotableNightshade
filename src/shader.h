...
public:
	...
	GLhandleARB getVertShader() const;
	GLhandleARB getFragShader() const;

	virtual void setParams(GLhandleARB programObject, GLuint startActiveTex) const = 0;
	virtual int getActiveTexCount() const = 0;

	virtual bool isSupported() const; // Whether shaders were loaded and compiled successfully
